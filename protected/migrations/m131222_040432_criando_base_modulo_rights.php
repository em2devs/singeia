...
class m131222_040432_criando_base_modulo_rights extends CDbMigration
{
	public function up()
	{
                ...
                $this->insert('tbl_rights_auth_item'        , array('name'=>'Admin'         , 'type'=>2     , 'description'=>'Administrador'    , 'bizrule'=>NULL                                   , 'data'=>'N;'));
                $this->insert('tbl_rights_auth_item'        , array('name'=>'Authenticated' , 'type'=>2     , 'description'=>'Autenticado'      , 'bizrule'=>'return !Yii::app()->user->isGuest;'   , 'data'=>'N;'));
                $this->insert('tbl_rights_auth_item'        , array('name'=>'Guest'         , 'type'=>2     , 'description'=>'Visitante'        , 'bizrule'=>'return Yii::app()->user->isGuest;'    , 'data'=>'N;'));
